...
var g_logger *zap.SugaredLogger
...
func init() {
	...
	flag.IntVar(&MaxSize, "max_log_size", 200, "max log file size")
	...
	module.Define("", init_xlog, fin_xlog)
}
...
func (lconf *LoggerConfig) NewLogger(flag bool) *zap.SugaredLogger {
