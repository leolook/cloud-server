...
//			f.appendField(b, entry.Time.Format(timestampFormat));
//			//f.appendKeyValue(b, "time", entry.Time.Format(timestampFormat), true)
//		}
//
//		f.appendField(b, entry.Level.String())
...
//}
//
//func (f *TextFormatter) appendKeyValue(b *bytes.Buffer, key string, value interface{}, _appendSpace bool) {
//	b.WriteByte('[')
//	b.WriteString(key)
//	b.WriteByte('=')
...
//
//
//func (f *TextFormatter) appendField(b *bytes.Buffer, value interface{}) {
//	switch value := value.(type) {
//	case string:
//		b.WriteByte('[')
//		b.WriteString(value);
